                ...
                filters: [
                    {
                        memcmp: {
                            offset: 0,
                            bytes: bs58__default["default"].encode(buffer.Buffer.from([MetaplexKey.AuctionManagerV2])),
                        },
                    },
                    filters.store && {
                        memcmp: {
                ...
                filters: [
                    {
                        memcmp: {
                            offset: 0,
                            bytes: bs58__default["default"].encode(buffer.Buffer.from([MetaplexKey.BidRedemptionTicketV2])),
                        },
                    },
                    {
                        memcmp: {
                ...
                filters: [
                    {
                        memcmp: {
                            offset: 0,
                            bytes: bs58__default["default"].encode(buffer.Buffer.from([MetaplexKey.PayoutTicketV1])),
                        },
                    },
                    {
                        memcmp: {
                ...
                filters: [
                    {
                        memcmp: {
                            offset: 0,
                            bytes: bs58__default["default"].encode(buffer.Buffer.from([MetaplexKey.WhitelistedCreatorV1])),
                        },
                    },
                ],
                ...
                filters: [
                    {
                        memcmp: {
                            offset: 0,
                            bytes: bs58__default["default"].encode(buffer.Buffer.from([VaultKey.SafetyDepositBoxV1])),
                        },
                    },
                    {
                        memcmp: {
                ...
                filters: [
                    {
                        memcmp: {
                            offset: 0,
                            bytes: bs58__default["default"].encode(buffer.Buffer.from([MetadataKey.EditionV1])),
                        },
                    },
                    {
                        memcmp: {
            ...
            const baseFilters = [
                {
                    memcmp: {
                        offset: 0,
                        bytes: bs58__default["default"].encode(buffer.Buffer.from([MetadataKey.MetadataV1])),
                    },
                },
